        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuSub>
            ...
            <DropdownMenuPortal>
              <DropdownMenuSubContent>
                <DropdownMenuRadioGroup
                  value={values.bannerDescriptionHeight}
                  onValueChange={(value: any) => setValue("bannerDescriptionHeight", value)}
                >
          ...
          <DropdownMenuSub>
            ...
            <DropdownMenuPortal>
              <DropdownMenuSubContent>
                <DropdownMenuRadioGroup
                  value={values.bannerDescriptionWeight}
                  onValueChange={(value: any) => setValue("bannerDescriptionWeight", value)}
                >
