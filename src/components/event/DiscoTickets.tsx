      ...
      {discoTickets?.length !== 0 && (
        <>
          ...
          <div className="flex justify-center pb-4">
            <div
              style={{
                background: `${discoDetail.discoColor.ticketH1Color}99`,
                border: `solid 3px`,
                borderColor: `${discoDetail.discoColor.ticketH1Color}`,
              }}
                ...
                return (
                  <div key={ticket.id} className="w-full md:w-1/2 lg:w-2/3">
                    <div className="relative">
                      ...
                      >
                        <div style={{ color: `${discoDetail.discoColor.buttonTicketForeground}` }} className="w-full">
                          <p className="text-sm font-semibold">Reserve {ticket.category} tickets</p>
                          <div className="flex gap-3 items-center">
                            <div className="flex items-center gap-2">
                              <CreditCard style={{ stroke: `${discoDetail.discoColor.buttonTicketForeground}` }} />
                              <div className="text-sm"> ${ticket.price} c/u</div>
                            </div>
                            {(ticket.category === "VIP" || ticket.category === "economy") && (
                              <div className="flex items-center gap-2">
                                <RockingChair stroke={`${discoDetail.discoColor.buttonTicketForeground}`} />
                          ...
                          <div style={{ color: `${discoDetail.discoColor.buttonTicketForeground}` }}>
                            ...
                            <div className="w-full flex items-center justify-center gap-2">
                              <CalendarDays style={{ stroke: `${discoDetail.discoColor.buttonTicketForeground}` }} />
